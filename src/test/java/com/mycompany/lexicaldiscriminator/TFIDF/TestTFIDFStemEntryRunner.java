...
import com.mycompany.lexicaldiscriminator.start.StemEntryFrequencyTreeMap;
...
public class TestTFIDFStemEntryRunner {
	...
	@Test
	public void testRun() {
		// This string was sourced from the John Young Brown Wikipedia article
		// on 28June2014 @
		// http://en.wikipedia.org/wiki/John_Y._Brown_(politician,_born_1835)
		String wikiExcerpt = "John Young Brown (June 28, 1835 – January 11, 1904) was a politician from the US state of Kentucky. "
				...
				+ "The censure was later expunged from the congressional record. After his service in the House, Brown took a break from politics, "
				+ "but re-entered the political arena as a candidate for governor of Kentucky in 1891. "
				+ "He secured the Democratic nomination in a four-way primary election, then convincingly won the general election over his Republican challenger, "
				+ "Andrew T. Wood. Brown's administration, and the state Democratic Party, were split between gold standard supporters (including Brown) and supporters "
				+ "of the free coinage of silver. Brown's was also the first administration to operate under the Kentucky Constitution of 1891, and most of the legislature's "
				+ "time was spent adapting the state's code of laws to the new constitution. Consequently, little of significance was accomplished during Brown's term. "
				+ "Brown hoped the legislature would elect him to the U.S. Senate following his term as governor. Having already alienated the free silver faction of his party, "
				+ "he backed \"Goldbug\" candidate Cassius M. Clay, Jr. for the Democratic nomination in the upcoming gubernatorial election. "
				...
				+ "At the Democratic nominating convention of 1899, candidate William Goebel used questionable tactics to secure the gubernatorial nomination, "
				+ "and a disgruntled faction of the party held a separate nominating convention, choosing Brown to oppose Goebel in the general election. "
		...
		// convert hashmaps to sorted treemaps so that the order is constant and
		// defined
	...
	private String sefmTExpected = "{\n" + "[[', ', POS] | 1]\n" + "[['', '', ''] | 1]\n" + "[['s, 's, POS] | 6]\n"
			...
			+ "[[which, which, WDT] | 2]\n" + "[[won, win, VBD] | 1]\n" + "[[winner, winner, NN] | 1]\n"
			+ "[[would, would, MD] | 1]\n" + "[[years, year, NNS] | 1]\n" + "[[yet, yet, RB] | 1]\n" + "}";
	private final String sefmpTExpected = "{\n" + "[[', ', POS] | 1]\n" + "[['', '', ''] | 1]\n"
			+ "[['s, 's, POS] | 1]\n" + "[[,, ,, ,] | 1]\n" + "[[--, --, :] | 1]\n" + "[[-LRB-, -lrb-, -LRB-] | 1]\n"
			+ "[[-RRB-, -rrb-, -RRB-] | 1]\n" + "[[., ., .] | 1]\n" + "[[11, 11, CD] | 1]\n"
			+ "[[1835, 1835, NNP] | 1]\n" + "[[1859, 1859, CD] | 1]\n" + "[[1866, 1866, NNP] | 1]\n"
			+ "[[1871, 1871, CD] | 1]\n" + "[[1872, 1872, CD] | 1]\n" + "[[1891, 1891, CD] | 1]\n"
